...
u8 MDIO_u8GetPortVal(u8 A_u8PortNo)
{
	...
	switch (A_u8PortNo)
	{
		case DIO_PORTA: L_u8PortVal = PINA; break;
		case DIO_PORTB: L_u8PortVal = PINB; break;
		case DIO_PORTC: L_u8PortVal = PINC; break;
		case DIO_PORTD: L_u8PortVal = PIND; break;
	}
...
void MDIO_vTogPinVal(u8 A_u8PortNo, u8 A_u8PinNo)
{
	switch (A_u8PortNo)
	{
		...
		default: break;  // Invalid port, do nothing
	}
}
